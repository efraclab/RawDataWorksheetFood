...
export function mapPreservativeDraftToPreparations(
    draft: any
): PreparationData[] {
...
function getSafeISOString(
    ...
    if (
        ...
        console.warn(
            "Invalid Preservative completedAt:",
            value
        );
...
export function mapPreservativeDraftToFiles(
    draft: any
): WorksheetFileData[] {
...
export function mapPreservativeDraftToCalculations(
    draft: any
): CalculationData[] {
