...
export function mapMoistureDraftToPreparations(
    draft: any
): PreparationData[] {
...
export function mapMoistureDraftToFiles(
    draft: any
): WorksheetFileData[] {
...
export function mapMoistureDraftToCalculations(
    draft: any
): CalculationData[] {
