...
// ============================================================
// ARTIFICIAL COLOUR PREPARATIONS
// ============================================================

export function mapArtificialColourDraftToPreparations(
    draft: any
): PreparationData[] {
...
function getSafeISOString(
    ...
    if (
        ...
        console.warn(
            "Invalid Artificial Colour completedAt:",
            value
        );
...
// ============================================================
// ARTIFICIAL COLOUR FILES
// ============================================================

export function mapArtificialColourDraftToFiles(
    draft: any
): WorksheetFileData[] {
...
// ============================================================
// ARTIFICIAL COLOUR CALCULATIONS
// ============================================================

export function mapArtificialColourDraftToCalculations(
    draft: any
): CalculationData[] {
