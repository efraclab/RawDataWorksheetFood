...
const CalculationDetailORS: React.FC<Props> = ({
  ...
  const computeResult = (
    ...
    const denominator = sw1n * 1_000_000 * mwN * lcN;
              ...
              <div className="bg-white rounded-lg p-4 border-2 border-emerald-200 shadow-sm">
                ...
                <div className="bg-gray-50 rounded p-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-black">% of L.C.</span>
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="min-w-0">
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="w-20 shrink-0"><CustomDropdown options={sachetWeightUnitOptions} value={calculation.sachetWeightAvgUnit} onChange={(v) => handleField("sachetWeightAvgUnit", v)} placeholder="Unit" colorScheme="emerald" /></div>
                    </div>
                  ...
                  <div className="min-w-0 md:col-span-2 lg:col-span-1">
                    ...
                    <input type="number" step="any" value={calculation.labelClaim} readOnly={isLocked} onChange={(e) => handleField("labelClaim", e.target.value)} onWheel={(e) => e.currentTarget.blur()} placeholder="0.0" className={`w-full px-3 py-2 bg-white border rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-emerald-400 ${!calculation.labelClaim ? "border-amber-400" : "border-emerald-300"}`} />
                    {!calculation.labelClaim && <p className="text-[10px] text-amber-600 mt-1 flex items-center gap-1"><AlertTriangle className="w-3 h-3" /> Required</p>}
                  </div>
                </div>
              </div>
                    ...
                    <div className="flex flex-col items-center">
                      <div className="text-center border-b-2 border-black pb-2 mb-2 px-2 w-full">
                        <p className="text-xs font-mono text-black break-words">
                          ...
                          {" × "}{fmtN4(sachetNum)} × 100 × 1000
                        </p>
                        <p className="text-[10px] text-gray-500 mt-0.5">(Sample/Blank shown in ppm; Sachet in g; MW in g/mol after conversion)</p>
                      </div>
                      <div className="text-center px-2 w-full">
                        <p className="text-xs font-mono text-black break-words">
                          {fmtN4(safeNum(calculation.sw1))} × 1,000,000 × {fmtN4(mwNum)} × {fmtN4(lcNum)}
                        </p>
                      </div>
                    </div>
                  </div>
