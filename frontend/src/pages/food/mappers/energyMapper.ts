...
export function mapEnergyDraftToPreparations(
    draft: any
): PreparationData[] {
...
export function mapEnergyDraftToFiles(
    draft: any
): WorksheetFileData[] {
...
export function mapEnergyDraftToCalculations(
    draft: any
): CalculationData[] {
