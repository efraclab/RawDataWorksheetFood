...
const createNewCalculationZptoShampoo = (
  ...
  w1EmptyPycnometer: "",
  w1Unit: "g",
  w2PycnometerWithSample: "",
  w2Unit: "g",
  w3PycnometerWithWater: "",
  w3Unit: "g",
  specificGravity: "",
  molecularWeight1: "",
  molecularWeight2: "",
            ...
            switch (calcType) {
              ...
              case "zpto_shampoo": {
                const zptoCalc: CalculationZptoShampoo = {
                  ...
                  v2: parsedData.v2 ?? null,
                  v3: parsedData.v3 ?? null,
                  w1EmptyPycnometer: parsedData.w1EmptyPycnometer || "",
                  w1Unit: parsedData.w1Unit || "g",
                  w2PycnometerWithSample: parsedData.w2PycnometerWithSample || "",
                  w2Unit: parsedData.w2Unit || "g",
                  w3PycnometerWithWater: parsedData.w3PycnometerWithWater || "",
                  w3Unit: parsedData.w3Unit || "g",
